...
//trex 
  //1 trex = createSprite(50, height - 70, 20, 50);
  trex = createSprite(50,170,50,50);
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.5;
//solo
  //1 ground = createSprite(width / 2, height - 20, width, 20);
  ground = createSprite(300,180,600, 20);
  ground.addImage("ground", groundImage);
  ground.x = ground.width / 2;
  
//criando a sprite gameOver... 
  //1 gameOver = createSprite(width / 2, height / 2);
  gameOver = createSprite(300,100,50,50);
  gameOver.addImage(gameOverImg);
  gameOver.scale = 0.5;
//criando a sprite restart...
  //1 restart = createSprite(width / 2, height / 2 + 50);
...
//solo invisível
  //1 invisibleGround = createSprite(width / 2, height - 10, width, 10);
